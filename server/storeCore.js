...
export function cloneDefaultStoreData() {
  return deepClone(defaultStoreData);
}
...
export function listPublicProducts(data, filters = {}) {
  return sortByNewest(applyProductFilters(data.products, filters, { admin: false }));
}

export function listAdminProducts(data, filters = {}) {
  return sortByNewest(applyProductFilters(data.products, filters, { admin: true }));
}

export function getProduct(data, identifier) {
  return data.products.find((product) => product.id === identifier || product.slug === identifier) || null;
}

export function createProduct(data, input) {
...
export function updateProduct(data, productId, input) {
...
export function upsertProfile(data, input, profileId) {
...
export function createOrder(data, payload) {
...
export function updateOrder(data, orderId, input) {
...
export function getRecommendations(data, filters = {}) {
  return listPublicProducts(data, filters)
    .sort((left, right) => {
...
export function getAdminSummary(data) {
